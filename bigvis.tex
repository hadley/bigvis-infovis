...
Figure~\ref{fig:benchmark} provides basic benchmarks for the bigvis package, over a range of data input sizes, bins and summary statistics. Timings performed were a 2.6 GHz Intel Core i7, 15\" MacBook retina. The benchmarks assume the data are already in memory: loading data from R's binary data format order of 5 for $10^8$ observations.
